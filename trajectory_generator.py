...
class QuinticPolynom:
    def __init__(self, start_d, start_v, start_a, end_d, end_v, end_a, T):
        ...
        self.a4 = x[1, 0]
        self.a5 = x[2, 0]
        # NOTE: a print() used to live here and fired on every instantiation --
        # with 3 lanes x 3 times x 3 speeds = 27 calls/tick at 20Hz, that was
        # the source of the terminal spam. Removed; use logging.debug() here
        # if you need to inspect a specific polynomial's target again.
...
if __name__ == "__main__":
    # Quick sanity check to make sure the math works before plugging it into
    # CARLA. Guarded so importing this module (as ego_camera.py does) doesn't
